...
| `subject` | Union of:<br/>&nbsp;&nbsp;[`com.atproto.admin.defs#repoRef`](/com/atproto/admin/defs#repoRef)<br/>&nbsp;&nbsp;[`com.atproto.repo.strongRef`](/com/atproto/repo/strongref#undefined)<br/>&nbsp;&nbsp;[`chat.bsky.convo.defs#messageRef`](/chat/bsky/convo/defs#messageRef) | ✅  |  |  |
...
| Name | Type | Req'd  | Description | Constraints |
|------|------|----------|-------------|-------------|
| `type` | [`com.atproto.moderation.defs#subjectType`](/com/atproto/moderation/defs#subjectType) | ✅  |  |  |
| `subject` | `string` | ✅  |  |  |
...
| `reportType` | [`com.atproto.moderation.defs#reasonType`](/com/atproto/moderation/defs#reasonType) | ✅  |  |  |
...
| `threatSignatures` | Array of [`com.atproto.admin.defs#threatSignature`](/com/atproto/admin/defs#threatSignature) | ❌  |  |  |
