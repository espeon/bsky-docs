...
| `cid` | `string` | ✅  |  | Format: `cid` |
| `record` | `unknown` | ✅  |  |  |
| `creator` | [`app.bsky.actor.defs#profileViewBasic`](/app/bsky/actor/defs#profileViewBasic) | ✅  |  |  |
| `list` | [`#listViewBasic`](#listviewbasic) | ❌  |  |  |
| `listItemsSample` | Array of [`#listItemView`](#listitemview) | ❌  |  | Max Items: 12 |
| `feeds` | Array of [`app.bsky.feed.defs#generatorView`](/app/bsky/feed/defs#generatorView) | ❌  |  | Max Items: 3 |
