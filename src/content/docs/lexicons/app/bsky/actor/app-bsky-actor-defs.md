...
| `postsCount` | `integer` | ❌  |  |  |
| `associated` | [`#profileAssociated`](#profileassociated) | ❌  |  |  |
| `joinedViaStarterPack` | [`app.bsky.graph.defs#starterPackViewBasic`](/app/bsky/graph/defs#starterPackViewBasic) | ❌  |  |  |
| `indexedAt` | `string` | ❌  |  | Format: `datetime` |
| `createdAt` | `string` | ❌  |  | Format: `datetime` |
| `viewer` | [`#viewerState`](#viewerstate) | ❌  |  |  |
| `labels` | Array of [`com.atproto.label.defs#label`](/com/atproto/label/defs#label) | ❌  |  |  |
...
|------|------|----------|-------------|-------------|
| `muted` | `boolean` | ❌  |  |  |
| `mutedByList` | [`app.bsky.graph.defs#listViewBasic`](/app/bsky/graph/defs#listViewBasic) | ❌  |  |  |
| `blockedBy` | `boolean` | ❌  |  |  |
| `blocking` | `string` | ❌  |  | Format: `at-uri` |
| `blockingByList` | [`app.bsky.graph.defs#listViewBasic`](/app/bsky/graph/defs#listViewBasic) | ❌  |  |  |
...
| `activitySubscription` | [`app.bsky.notification.defs#activitySubscription`](/app/bsky/notification/defs#activitySubscription) | ❌  | This property is present only in selected cases, as an optimization. |  |
...
| Name | Type | Req'd  | Description | Constraints |
|------|------|----------|-------------|-------------|
| `items` | Array of [`app.bsky.actor.defs#savedFeed`](/app/bsky/actor/defs#savedFeed) | ✅  |  |  |
...
| `targets` | Array of [`app.bsky.actor.defs#mutedWordTarget`](/app/bsky/actor/defs#mutedWordTarget) | ✅  | The intended targets of the muted word. |  |
...
| Name | Type | Req'd  | Description | Constraints |
|------|------|----------|-------------|-------------|
| `items` | Array of [`app.bsky.actor.defs#mutedWord`](/app/bsky/actor/defs#mutedWord) | ✅  | A list of words the account owner has muted. |  |
...
| `nuxs` | Array of [`app.bsky.actor.defs#nux`](/app/bsky/actor/defs#nux) | ❌  | Storage for NUXs the user has encountered. | Max Items: 100 |
...
| `record` | `unknown` | ✅  |  |  |
| `embed` | Union of:<br/>&nbsp;&nbsp;[`app.bsky.embed.external#view`](/app/bsky/embed/external#view) | ❌  | An optional embed associated with the status. |  |
